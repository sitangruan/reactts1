...
describe('todo actions', () => {
  it('The method loadTodoAction should create LOAD_TODO action', () => {
    ...
    expect(actions.loadTodoListAction(myList)).toEqual(new TodoAction(TodoActionType.LOAD, myList));
  });

  it('The method addTodoAction should create ADD_TODO action', () => {
    const myTodo = new TodoElement(456, 789, 'Test todo 321', true);
    expect(actions.addTodoAction(myTodo)).toEqual(new TodoAction(TodoActionType.ADD, myTodo));
  });
});
